class Vision < Formula
  ...
  url "https://api.github.com/repos/faithoflifedev/google_vision/tarball/v1.0.7+6"
  sha256 "88872113dcc4eb6ce3a700a9791ac7c3e385317510e258917b122b1f9afa62cc"
  license "MIT"
  ...
  test do
    assert_match "obs_websocket v1.0.7+6", shell_output("bin/vision version")
  end
end