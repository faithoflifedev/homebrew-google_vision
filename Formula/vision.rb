class Vision < Formula
  ...
  url "https://api.github.com/repos/faithoflifedev/google_vision/tarball/v1.0.8+3"
  sha256 "791cd0fe98409dcbbcad2b9832832fcbc179f5f2f37db1557540fca5ef94c3f3"
  license "MIT"
  ...
  test do
    assert_match "obs_websocket v1.0.8+3", shell_output("bin/vision version")
  end
end