class Vision < Formula
  ...
  url "https://api.github.com/repos/faithoflifedev/google_vision/tarball/v1.0.6+4"
  sha256 "a68e127bbe065f63a96e4f1a3f4fbf19b0ec8f0787453cdb5cdeba16b8976ad2"
  license "MIT"
  ...
  test do
    assert_match "obs_websocket v1.0.6+4", shell_output("bin/vision version")
  end
end