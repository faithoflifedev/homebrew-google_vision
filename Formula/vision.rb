class Vision < Formula
  ...
  url "https://api.github.com/repos/faithoflifedev/google_vision/tarball/v1.0.7+4"
  sha256 "98cb6653ace12615f323693f4361a08b4f6815691e7548aeffb6a94ef97df7f9"
  license "MIT"
  ...
  test do
    assert_match "obs_websocket v1.0.7+4", shell_output("bin/vision version")
  end
end