class Vision < Formula
  ...
  url "https://api.github.com/repos/faithoflifedev/google_vision/tarball/v1.0.6+2"
  sha256 "e2c2717bbf9fcd716e87109ff4a9efb5d2ccfbb006b4a2e5ccf775adf4fe7bf7"
  license "MIT"
  ...
  test do
    assert_match "obs_websocket v1.0.6+2", shell_output("bin/vision version")
  end
end