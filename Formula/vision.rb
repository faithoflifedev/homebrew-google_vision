class Vision < Formula
  ...
  url "https://api.github.com/repos/faithoflifedev/google_vision/tarball/v1.0.6"
  sha256 "8281b8dccc90db1d0fc1d7d4263854bc8eebf89fa333813665dbbf59f51e242d"
  license "MIT"
  ...
  test do
    assert_match "obs_websocket v1.0.6", shell_output("bin/vision version")
  end
end