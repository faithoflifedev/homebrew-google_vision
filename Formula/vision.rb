class Vision < Formula
  ...
  url "https://api.github.com/repos/faithoflifedev/google_vision/tarball/v1.0.7+3"
  sha256 "3cb8da4ff89eaf4c73c5eae1488c76ee5295e76fe093ecc7df10b13a8d96fee5"
  license "MIT"
  ...
  test do
    assert_match "obs_websocket v1.0.7+3", shell_output("bin/vision version")
  end
end